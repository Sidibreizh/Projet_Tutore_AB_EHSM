...
$donnees = executeRequete("SELECT idSsCategorie, nomSsCategorie, imgSsCat, descriptionSsCat FROM `souscategorie_produit` where idCategorie = 2");
...
<section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/istockphoto-1164853312-170667a.jpg)">
    <div class="container">
        <div class="row">
