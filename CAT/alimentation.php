...
$donnees = executeRequete("SELECT idSsCategorie, nomSsCategorie, imgSsCat, descriptionSsCat FROM `souscategorie_produit` where idCategorie = 1");
...
<section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/photo_alimentation.jpeg)">
    <div class="container">
        <div class="row">
