...
$donnees = executeRequete("SELECT idSsCategorie, nomSsCategorie, imgSsCat, descriptionSsCat FROM `souscategorie_produit` where idCategorie = 5");
...
<section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/Photo_jouets.jpg)">
    <div class="container">
        <div class="row">
