...
$donnees = executeRequete("SELECT idSsCategorie, nomSsCategorie, imgSsCat, descriptionSsCat FROM `souscategorie_produit` where idCategorie = 4");
...
<section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/Photo_arbre.jpg)">
    <div class="container">
        <div class="row">
